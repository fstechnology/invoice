            ...
            <div class="x_content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Items <a class="btn btn-sm btn-primary" id="btnAddItem">Add Item</a></h2>
                ...
                <div class="row">
                    <div class="col-md-4 pull-right">
                        <?= $form->field($model, 'sub_total')->textInput(['type' => 'number', 'maxlength' => true, 'value' => "0", 'readonly' => 'true']) ?>
                        <?= $form->field($model, 'tax_amount')->textInput(['type' => 'number', 'maxlength' => true, 'value' => "0", 'readonly' => 'true']) ?>
                        <?= $form->field($model, 'payment')->textInput(['type' => 'number', 'step' => 'any', 'maxlength' => true, 'value' => "0"]) ?>
                        <br />
                        <?= $form->field($model, 'amount_due')->textInput(['type' => 'number', 'maxlength' => true, 'value' => "0", 'readonly' => 'true']) ?>
...
<script>
    ...
    function generateFormItem(indexItem) {
        return `
                <tr class="">
                    <td class=""><input class="form-control form-control-sm ipt-item-type" type="text" required readonly/></td>
                    <td class="">
                        <select class="form-control form-control-sm slc-item" name="Invoice[InvItems][${indexItem}][item_id]" required>
                            ${selectItemOptions}
                        </select>
                    </td>
                    <td class=""><input class="form-control form-control-sm ipt-price"  name="Invoice[InvItems][${indexItem}][unit_price]" placeholder="Unit Price" type="number" value="0" min="0" required readonly/></td>
                    <td class=""><input class="form-control form-control-sm ipt-quantity"  name="Invoice[InvItems][${indexItem}][quantity]" placeholder="Quantity" type="number" value="1" min="1" required/></td>
                    <td class=""><input class="form-control form-control-sm ipt-total-amount"  name="Invoice[InvItems][${indexItem}][total_amount]" placeholder="Total Amount" type="number" value="0" min="0" required readonly/></td>
    ...
    $("#btnAddItem").click(function () {
        indexItem += 1;
        $("#tbl-item-body").append(generateFormItem(indexItem))
        return false;
    })
